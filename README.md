...
[![ci](https://github.com/pavlospt/manual-approval/actions/workflows/ci.yaml/badge.svg)](https://github.com/pavlospt/manual-approval/actions/workflows/ci.yaml)
...
```yaml
steps:
  - uses: pavlospt/manual-approval@main
    with:
      secret: ${{ github.TOKEN }}
...
```
$ VERSION=1.7.1-rc.1 make IMAGE_REPO=ghcr.io/pavlospt/manual-approval-test build
```
